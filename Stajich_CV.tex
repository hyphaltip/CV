...
\item [2019-2025] Canadian Institute For Advanced Research \\
...
\item [2022-2026] National Science Foundation. Reccomended for funding \\
...
\item Steven Bolaris, PhD, GGB $\triangle$
...
\item Sawyer Masonjones, MS, GGB $\star$
\item [ongoing] Jes\'{u}s Pe\~{n}a, Microbiology $\star$
...
\item Jericho Ortanez, Microbiology
...
\item $\cdot$ University of Georgia, Guest lecture for undergraduate seminar course "Genome Biology Across the Tree of Life"
\item $\cdot$ Rochester Institute of Technology, Georgia Gosnell Seminar Series
\item $\cdot$ Unversity of Deleware, Microbiology Graduate Program
\item $\cdot$ Canadian Fungal Network Conference, Plenary Speaker
